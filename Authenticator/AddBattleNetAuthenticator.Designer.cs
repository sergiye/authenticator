...
namespace Authenticator
{
	partial class AddBattleNetAuthenticator
	{
		...
		private void InitializeComponent()
		{
			...
			this.lnewLabel4 = new Label();
			this.label2 = new Label();
			this.newLabel1 = new Label();
			this.restoreRestoreCodeField = new TextBox();
			this.label7 = new Label();
			this.restoreSerialNumberField = new TextBox();
			this.label8 = new Label();
			this.label9 = new Label();
			this.importPrivateKeyField = new TextBox();
			...
			this.restoreAuthenticatorTab = new TabPage();
			this.importAuthenticatorTab = new TabPage();
