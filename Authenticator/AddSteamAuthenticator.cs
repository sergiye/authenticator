  ...
  public partial class AddSteamAuthenticator : ResourceForm {
    ...
    private bool ImportSteamGuard() {
      ...
      if (string.IsNullOrEmpty(deviceId) ||
          Regex.IsMatch(deviceId, @"android:[0-9abcdef-]+", RegexOptions.Singleline | RegexOptions.IgnoreCase) ==
          false) {
    ...
    private void LoadSdaFile(string mafile, string password = null, string steamid = null, string iv = null,
      ...
      if (string.IsNullOrEmpty(password) == false) {
        ...
        using (var pbkdf2 =
               new Rfc2898DeriveBytes(password, Convert.FromBase64String(salt), ImportedSdaEntry.PBKDF2_ITERATIONS)) {
        ...
        try {
          ...
          if (result == false) {
            ...
            if (mEnroll.Requires2Fa) {
              MainForm.ErrorDialog(this, "It looks like you already have an authenticator added to you account", null,
            ...
            if (mEnroll.RequiresEmailAuth) {
              ...
              var email = string.IsNullOrEmpty(mEnroll.EmailDomain) == false
                ? "***@" + mEnroll.EmailDomain
                : string.Empty;
          ...
          if (MainForm.ErrorDialog(this, "An error occurred while registering the authenticator", iere,
