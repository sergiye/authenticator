...
namespace Authenticator
{
	partial class AddMicrosoftAuthenticator
	{
		...
		private void InitializeComponent()
		{
			...
			this.allowCopyButton = new CheckBox();
			this.codeField = new SecretTextBox();
			this.verifyAuthenticatorButton = new Button();
			this.secretCodeField = new TextBox();
			this.label3 = new Label();
			this.step9Label = new Label();
			this.label2 = new Label();
			this.okButton = new Button();
			this.cancelButton = new Button();
			this.icon3RadioButton = new GroupRadioButton();
			this.icon2RadioButton = new GroupRadioButton();
			this.icon1RadioButton = new GroupRadioButton();
