...
namespace Authenticator
{
	partial class AddTrionAuthenticator
	{
		...
		private void InitializeComponent()
		{
			...
			this.allowCopyNewButton = new CheckBox();
			this.enrollAuthenticatorButton = new Button();
			this.label3 = new Label();
			this.label8 = new Label();
			this.label2 = new Label();
			this.label1 = new Label();
			this.restoreAnswer2Field = new TextBox();
			this.restoreAnswer1Field = new TextBox();
			this.restoreGetQuestionsButton = new Button();
			this.restoreQuestion1Label = new Label();
			this.label13 = new Label();
			this.restoreQuestion2Label = new Label();
			this.label12 = new Label();
			this.label5 = new Label();
			this.restoreDeviceIdField = new TextBox();
			this.restorePasswordField = new TextBox();
			this.restoreEmailField = new TextBox();
			...
			this.newAuthenticatorTab = new TabPage();
			...
			this.recoverAuthenticatorTab = new TabPage();
